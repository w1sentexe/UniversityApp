const CACHE_NAME = "vsuet-rating-v56";
const STATIC_ASSETS = [
  "./",
  "./index.html",
  "./css/tokens.css?v=55",
  "./css/base.css?v=55",
  "./css/controls.css?v=55",
  "./css/login.css?v=55",
  "./css/app-shell.css?v=55",
  "./css/rating.css?v=55",
  "./css/kt-popup.css?v=55",
  "./css/schedule.css?v=55",
  "./css/settings.css?v=55",
  "./js/main.js?v=55",
  "./js/config.js",
  "./js/utils.js",
  "./js/api.js",
  ...
  "./js/view-settings.js",
  "./js/view-schedule.js",
  "./js/data/rating-cache.js",
  "./js/data/schedule.js",
  "./js/data/snapshot-status.js",
  "./js/kt-popup.js",
  "./js/sw-register.js",
  "./resources/logo.svg",
